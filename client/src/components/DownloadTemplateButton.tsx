  ...
  const handleDownloadTemplate = () => {
    try {
      ...
      const instructionsData = [
        ...
        { "Campo": "Telefone", "Obrigatório": "Sim *", "Descrição": "Telefone do contato. Obrigatório se 'Email' estiver vazio." },
        { "Campo": "Email", "Obrigatório": "Sim *", "Descrição": "Email do contato. Obrigatório se 'Telefone' estiver vazio." },
        ...
        { "Campo": "Valor Estimado", "Obrigatório": "Não", "Descrição": "Valor numérico do negócio (ex: 15000). Sem R$, sem pontos." },
        { "Campo": "Origem", "Obrigatório": "Não", "Descrição": "Origem do contato/negócio (ex: Site, Indicação, Prospecção Ativa)." },
        { "Campo": "Tags", "Obrigatório": "Não", "Descrição": "Nome da tag existente no CRM. Apenas tags já cadastradas serão aplicadas." },
