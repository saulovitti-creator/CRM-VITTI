  ...
  return (
    <div
      ...
      className={[
        ...
        isOver ? "kanban-drop-zone-active" : "bg-muted",
      ].join(" ")}
    >
      {/* Stage Header */}
      <div className={[
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="bg-background text-muted-foreground text-xs px-1.5 py-0.5 rounded-md font-medium border shadow-sm">
